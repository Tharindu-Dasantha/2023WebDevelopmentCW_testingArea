...
function handleClick(event) {
  ...
  switch (clickedDivId) {
    case "movie":
      window.location.href = "../Gallery/movie.html";
      break;
    case "anime":
      window.location.href = "../Gallery/anime.html";
      break;
    case "tv":
      window.location.href = "../Gallery/tv.html";
      break;
    case "cartoon":
      window.location.href = "../Gallery/cartoon.html";
      break;
    default:
      break;
  }
